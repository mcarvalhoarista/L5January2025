...
| Ethernet2 | P2P_LINK_TO_DC1-CL2_Ethernet1 | routed | - | 172.16.1.32/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-CL3_Ethernet1 | routed | - | 172.16.1.64/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-CL4_Ethernet1 | routed | - | 172.16.1.96/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_DC1-BL1_Ethernet1 | routed | - | 172.16.1.128/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_DC1-BL2_Ethernet1 | routed | - | 172.16.1.160/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.250.1.25/32 |
...
| 172.16.1.33 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.1.65 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.1.97 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.1.129 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.1.161 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor 172.16.1.33 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.1.33 remote-as 65101
   neighbor 172.16.1.33 description DC1-CL2_Ethernet1
   neighbor 172.16.1.65 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.1.65 remote-as 65102
   neighbor 172.16.1.65 description DC1-CL3_Ethernet1
   neighbor 172.16.1.97 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.1.97 remote-as 65102
   neighbor 172.16.1.97 description DC1-CL4_Ethernet1
   neighbor 172.16.1.129 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.1.129 remote-as 65103
   neighbor 172.16.1.129 description DC1-BL1_Ethernet1
   neighbor 172.16.1.161 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.1.161 remote-as 65103
   neighbor 172.16.1.161 description DC1-BL2_Ethernet1
