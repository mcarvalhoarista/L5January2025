...
| --------- | --------------- | ------------ | --------- |
| DC2_BL | Vlan4094 | 10.251.2.9 | Port-Channel8 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet8 | MLAG_PEER_DC2-BL2_Ethernet8 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 8 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP1_Ethernet5 | routed | - | 172.16.2.17/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP2_Ethernet5 | routed | - | 172.16.2.19/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-BL1_Ethernet4 | routed | - | 172.16.255.1/31 | default | 1500 | False | - | - |
...
!
interface Ethernet8
   description MLAG_PEER_DC2-BL2_Ethernet8
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel8 | MLAG_PEER_DC2-BL2_Po8 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel8
   description MLAG_PEER_DC2-BL2_Po8
   no shutdown
   switchport
...
| Net-ID | 49.0001.1921.6820.0005.00 |
| Type | level-2 |
...
| 10.252.2.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65200
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC2-BL2
