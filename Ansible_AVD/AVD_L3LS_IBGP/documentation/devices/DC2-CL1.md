...
| --------- | --------------- | ------------ | --------- |
| DC2_RACK1 | Vlan4094 | 10.251.2.19 | Port-Channel8 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet8 | MLAG_PEER_DC2-CL2_Ethernet8 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 8 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP1_Ethernet1 | routed | - | 172.16.2.37/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP2_Ethernet1 | routed | - | 172.16.2.39/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel8 | MLAG_PEER_DC2-CL2_Po8 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.250.2.12/32 |
...
| Vlan3009 |  VRF_A  |  10.252.2.18/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.252.2.18/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.251.2.18/31  |  -  |  -  |  -  |  -  |  -  |
...
| Net-ID | 49.0001.1921.6820.0010.00 |
| Type | level-2 |
| Router-ID | 10.250.2.12 |
...
router isis EVPN_UNDERLAY
   net 49.0001.1921.6820.0010.00
   is-type level-2
   router-id ipv4 10.250.2.12
...
| 10.252.2.19 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.250.2.12:10010 | 10010:10010 | - | - | learned |
| 20 | 10.250.2.12:10020 | 10020:10020 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_A | 10.250.2.12:10 | connected |
...
router bgp 65200
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC2-CL2
   ...
   !
   vlan 10
      rd 10.250.2.12:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 20
      rd 10.250.2.12:10020
   ...
   vrf VRF_A
      ...
      router-id 10.250.2.12
      neighbor 10.252.2.19 peer group MLAG-IPv4-UNDERLAY-PEER
