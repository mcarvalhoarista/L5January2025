...
| --------- | --------------- | ------------ | --------- |
| DC2_RACK2 | Vlan4094 | 10.251.2.5 | Port-Channel8 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet8 | MLAG_PEER_DC2-CL4_Ethernet8 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 8 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP1_Ethernet3 | routed | - | 172.16.2.9/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP2_Ethernet3 | routed | - | 172.16.2.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet8
   description MLAG_PEER_DC2-CL4_Ethernet8
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel8 | MLAG_PEER_DC2-CL4_Po8 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel8
   description MLAG_PEER_DC2-CL4_Po8
   no shutdown
   switchport
...
| 10.252.2.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65200
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC2-CL4
