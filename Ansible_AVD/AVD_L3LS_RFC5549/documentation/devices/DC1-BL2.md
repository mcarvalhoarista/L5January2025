...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SP1_Ethernet6 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP2_Ethernet6 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet4 | P2P_LINK_TO_DC2-BL2_Ethernet4 | routed | - | - | default | 1500 | False | - | - | - | - |
...
| Loopback666 | VRF_A_VTEP_DIAGNOSTICS | VRF_A | 169.254.255.8/32 |
...
| 10.250.2.8 | 65203.0 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - | - |
...
| Ethernet4 | default | IPv4-UNDERLAY-PEERS | 65203.1 | - |
...
router bgp 65103.1
   ...
   neighbor interface Ethernet4 peer-group IPv4-UNDERLAY-PEERS remote-as 65203.1
   ...
   neighbor 10.250.2.8 remote-as 65203.0
...
```eos
!
ip address virtual source-nat vrf VRF_A address 169.254.255.8
```
