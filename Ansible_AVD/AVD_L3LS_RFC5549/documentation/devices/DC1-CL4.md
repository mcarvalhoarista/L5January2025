...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | DC1-SW2_Ethernet2 | *trunk | *10,20,30,40 | *- | *- | 3 |
| Ethernet4 | DC1-R2_Ethernet0/2 | *trunk | *10,20,30,40 | *- | *- | 4 |
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SP1_Ethernet4 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP2_Ethernet4 | routed | - | - | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet3
   description DC1-SW2_Ethernet2
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description DC1-R2_Ethernet0/2
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | DC1-SW2_PortChannel100 | switched | trunk | 10,20,30,40 | - | - | - | - | - | 0000:0000:4c44:3972:a4de |
| Port-Channel4 | DC1-R2_PortChannel100 | switched | trunk | 10,20,30,40 | - | - | - | - | - | 0000:0000:b3c9:dc7e:eb94 |
...
interface Port-Channel3
   description DC1-SW2_PortChannel100
   no shutdown
   switchport
...
interface Port-Channel4
   description DC1-R2_PortChannel100
   no shutdown
   switchport
   switchport trunk allowed vlan 10,20,30,40
   switchport mode trunk
   evpn ethernet-segment
      identifier 0000:0000:b3c9:dc7e:eb94
      route-target import b3:c9:dc:7e:eb:94
   lacp system-id b3c9.dc7e.eb94
   spanning-tree portfast
```
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.1.6/32 |
| Loopback666 | VRF_A_VTEP_DIAGNOSTICS | VRF_A | 169.254.255.6/32 |
