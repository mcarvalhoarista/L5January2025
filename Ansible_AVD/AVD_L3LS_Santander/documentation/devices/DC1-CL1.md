...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | Management_Interface | oob | MGMT | 10.88.169.135/24 | 10.88.169.129 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | DC1-SW1_Ethernet1 | *trunk | *10,20,30,40 | *- | *- | 3 |
| Ethernet4 | DC1-R1_Ethernet0/1 | *trunk | *10,20,30,40 | *- | *- | 4 |
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SP1_Ethernet1 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP2_Ethernet1 | routed | - | - | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet4
   description DC1-R1_Ethernet0/1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | DC1-SW1_PortChannel100 | switched | trunk | 10,20,30,40 | - | - | - | - | - | 0000:0000:64b8:a480:15f4 |
| Port-Channel4 | DC1-R1_PortChannel100 | switched | trunk | 10,20,30,40 | - | - | - | - | - | 0000:0000:71a3:4b0e:a7d5 |
...
| --------- | --------------------------- | --------------------------- | ------------ |
| Port-Channel3 | 0000:0000:64b8:a480:15f4 | single-active | 64:b8:a4:80:15:f4 |
| Port-Channel4 | 0000:0000:71a3:4b0e:a7d5 | all-active | 71:a3:4b:0e:a7:d5 |
...
interface Port-Channel3
   description DC1-SW1_PortChannel100
   no shutdown
   switchport
   switchport trunk allowed vlan 10,20,30,40
   switchport mode trunk
   evpn ethernet-segment
      identifier 0000:0000:64b8:a480:15f4
      redundancy single-active
      designated-forwarder election algorithm preference 100 dont-preempt
      route-target import 64:b8:a4:80:15:f4
   lacp system-id 64b8.a480.15f4
   spanning-tree portfast
!
interface Port-Channel4
   description DC1-R1_PortChannel100
   no shutdown
   switchport
   switchport trunk allowed vlan 10,20,30,40
   switchport mode trunk
   evpn ethernet-segment
      identifier 0000:0000:71a3:4b0e:a7d5
      route-target import 71:a3:4b:0e:a7:d5
   lacp system-id 71a3.4b0e.a7d5
   spanning-tree portfast
```
...
| Loopback666 | VRF_A_VTEP_DIAGNOSTICS | VRF_A | 169.254.255.3/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.250.1.1 | 65100.0 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
| 10.250.1.2 | 65100.0 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |

#### BGP Neighbor Interfaces

| Neighbor Interface | VRF | Peer Group | Remote AS | Peer Filter |
| ------------------ | --- | ---------- | --------- | ----------- |
| Ethernet1 | default | IPv4-UNDERLAY-PEERS | 65100.0 | - |
| Ethernet2 | default | IPv4-UNDERLAY-PEERS | 65100.0 | - |
...
```eos
!
ip address virtual source-nat vrf VRF_A address 169.254.255.3
```
